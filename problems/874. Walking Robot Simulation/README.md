<div class="notranslate"><p>A robot on an infinite XY-plane starts at point <code>(0, 0)</code> and faces north. The robot can receive one of three possible types of <code>commands</code>:</p>
